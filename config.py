...
TRAIN_CLASSIFICATION_FILE = 'data/Classification/train_classification.csv'
TEST_CLASSIFICATION_FILE = 'data/Classification/test_classification.csv'
VALID_CLASSIFICATION_FILE = 'data/Classification/test_classification.csv'
