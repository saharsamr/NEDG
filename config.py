...
MODEL_GENERATION_PATH = f'results/{MAX_CONTEXT_NUMBER}_contexts_{DEFINITION_SOURCE}/'

EVALUATE_GENERATION = True
PRED_GENERATION_FILE_PATH = f'{MAX_CONTEXT_NUMBER}_contexts_{DEFINITION_SOURCE}_preds.csv'
